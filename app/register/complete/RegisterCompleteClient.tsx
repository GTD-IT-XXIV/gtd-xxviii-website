...
export default function RegisterCompleteClient() {
  ...
  const sessionId = params.get("session_id"); // ok
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center">
      ...
      <p className="mt-2 text-sm text-gray-400">Redirecting you to the home page…</p>

      {/* {sessionId && <p className="mt-4 text-xs text-gray-400">Session: {sessionId}</p>} */}
    </main>
  );
}
